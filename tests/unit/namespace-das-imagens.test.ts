...
const NAMESPACE_DESTE_REPO = "ghcr.io/bugzoidtm"; // fork Nutef CRM — publica as próprias imagens (nutef/registro-core.md)
...
describe("o kit aponta para o que o CI realmente publica", () => {
  it("os defaults de código e os labels de origem apontam para este repositório", () => {
    const repo = "https://github.com/bugzoidTM/nutef-crm";
