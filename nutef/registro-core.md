...
| 2026-09-18 (Fase 4) | `app/app/ai/funcionarios/page.tsx` (seção "Seu segmento") | Porta do template na página do fork (arquivo já do fork, listado por completude) | — | **Baixo** — arquivo nosso |
| 2026-09-19 (Fase 5) | `app/admin/(protected)/dashboard/page.tsx` (1 import + 1 componente) | Faixa de negócio (§27) em cima do dashboard do motor | Tela ganha 8 tiles | **Baixo** — a página do upstream é um delegador de 5 linhas |
| 2026-09-19 (Fase 5) | `components/admin/AdminSidebar.tsx` (rótulo "Cobrança" → "Clientes") | A página passou a ser a gestão de clientes SaaS (§28) | Só o rótulo | **Baixo** |
| 2026-09-19 (Fase 5) | `app/api/v1/admin/nutef/kpis/route.ts` (novo) | Rota da faixa de negócio | Rota admin nova | **Baixo** |
| 2026-09-19 | `tests/unit/painel-de-seguranca.test.tsx` (contagem 10→11 das conferências fixas) | O gate `billing` é conferência sem escolha; o teste fixa a contagem de propósito | Só o teste | **Baixo** |
