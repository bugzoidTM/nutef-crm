-- ============================================================================
-- Nutef CRM — apêndice de schema do fork, aplicado DEPOIS de supabase/baseline.sql
--
-- GERADO por `bash nutef/scripts/gerar-baseline.sh` a partir de
-- nutef/db/migrations/N*.sql, em ordem. Não edite à mão: edite a migration (ou
-- crie a próxima) e gere de novo. Cada bloco é idempotente, então este arquivo
-- inteiro pode ser reaplicado num banco que já o tem — é o que o
-- `deploy.sh schema` faz e o que o `update.sh` do upstream faz com o dele.
-- ============================================================================
